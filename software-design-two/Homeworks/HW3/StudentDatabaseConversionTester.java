...
public class StudentDatabaseConversionTester{
    ...
    public static void buildARandomDatabase() {
        ...
        try {
            ...
            System.err.println("Removal process interrupted. Not guaranteed to have completed.");
            System.err.println(" Remove all .csv and .ser files manually before running again.");
        }
